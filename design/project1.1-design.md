...
یک `struct` برای توصیف کننده‌ی فایل ایجاد می‌کنیم
...
که در آن ساخت فایل مشخص  است و برای تعیین `fd` از یک متغیر `global` در ریسه استفاده می‌کنیم که یک عدد یکتا با کمک آن تعیین کند.
...
این طراحی برای رفع نیازمندی بسته‌شدن فایل پس از اتمام کار ریسه و همچنین ادامه‌دار بودن دسترسی یک پردازه‌ی خاص به فایلی (ولو پس از حذف آن) طراحی شده است. چون دقیقا می‌دانیم که هر پردازه در کدام فایل‌ها دخالت دارد.
