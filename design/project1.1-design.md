...
تست `sc-boundary-۳` این حالت را چک کرده است. به این صورت که ابتدا مرز را تشخیص می‌دهد. سپس یک پله باز در پشته پایین‌تر می‌رود (که موجب می‌شود خارج از ناحیه‌ی کاربری قرار گیرد). سپس چون مقدار ۱۰۰ را می‌نوسد یک بایت آن در قضای معتبر و یک بخش آن در فضای نامعتبر قرار می‌گیرد.
