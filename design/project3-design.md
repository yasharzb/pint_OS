...
<div dir="rtl">
برای نوشتن در یک فایل در انتها تابع inode_write_at صدا شود. در ابتدای این تابع سعی میکنیم قفل inode مورد نظر را تصاحب کنیم و هر گاه از این تابع خارج شویم، قفل آن را آزاد میکنیم. بدین ترتیب دو ریسه به صورت همزمان نمیتوانند نمیکنند در یک پرونده بنویسند.
</div>
