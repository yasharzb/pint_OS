...
<img src="file_structure.jpg" alt="drawing" width="600"/>

 برای اینکه برای نگه‌داری و دسترسی به فایل‌ها با اندازه‌ی کوچک مجبور نباشیم از روی اشاره‌گرها حرکت کنیم و سرعت دسترسی بیشتر شود، ۱۶ بلوک مستقسیم در استراکت جا داده‌ ایم که هر کدام در سکتوری مجزا با حافظه‌ی ۵۱۲ بایت هستند. در صورتی که فایلی از این حجم بیشتر نیاز داشته  باشد، در وهله‌ی اول از یک اشاره‌گر غیر مستقیم که دارای ۱۲۸ بلوک داده است استفاده می‌کنیم. در صورتی که به فضای بیشتری نیاز داشته باشد از یک اشاره‌گر غیر مستقیم دو مرحله‌ای استفاده می‌کنیم که دارای ۱۲۸ اشاره‌گر غیر مستقیم است.


<div dir="rtl">
در ساختار inode_disk،تعدادی اشاره‌گر به سکتور اضافه شده که ۱۶ تای آن‌ها مستقیم به یک سکتور اشاره میکنند. دومی به صورت غیر مستقیم و با یک واسطه به ۱۲۸ سکتور و سومی به صورت غیر مستقیم و  و با دو مرحله به ۱۲۸ * ۱۲۸ سکتور اشاره میکند. 

ی

پس تعدادی سکتوری در دیسک خواهیم داشت که در آن‌ها ۱۲۸ 
اشاره‌گر به سکتور قرار دارد که معادل ساختار pointer_block است.

لازم است که برای هر inode بدانیم که این inode مربوط به یک پرونده است یا فهرست راهنما. به همین دلیل متغیر type اضافه شد.

همچنین برای این که دو پردازه همزمان به یک inode دسترسی نداشته باشند، یک قفل برای inode تعریف شده.
