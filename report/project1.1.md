...
```
 ...
 در این تابع مانند تابع setup_stack، یک صفحه حافظه متناظر با پشته کاربر ایجاد میکنیم و آرگومان ها را در آن قرار میدهیم. همچنین اندازه پشته را با اندازه صفحه حافظه مقایسه میکنیم و اگر صفحه به اندازه کافی فضا برای قرار دادن آرگومان ها نداشت، مقدار false را برمیگردانیم. 
...
در نهایت لازم است به این نکته اشاره کنیم که هر صفحه‌ای از حافظه که با تابع palloc_get_page گرفته شده در صورت بروز خطا (مثلا جا نشدن آرگومان ها در استک) و یا به اتمام رسیدن کار (مثلا صفحه های استفاده شده برای تجزیر آرگومان ها) آزاد شده‌اند.
...
تمرین نسبتا سخت بود از این نظر که به مقدار زیادی می‌بایست روی کد تسلط پیدا می‌کردیم. خواندن کد بقیه در حالت عادی هم کار نسبتا دشواری است چه رسد به اینکه همچین کد عظیمی منظور باشد =)))
همچنین سوالات بیش از حد دقیق بودند. با توجه به اینکه این یک طراحی بکر نبوده که محل پردازش طرح و تفکر یک جا باشد این سختی چند برابر می‌شد. چه بسا اینکه یک سری سوالات اساسا دغدغه نبوده یا اینکه به صورت گنگی مطرح شدند.
و نهایتا اینکه وقت بسیار زیادی گرفت. تقریبا هر روز دست کم چند ساعت وقت سر گفتگو یا نوشتن مستند یا مطالعه سپری می‌شد.

> آیا شما بخشی را در تمرین یافتید که دید عمیق‌تری نسبت به طراحی سیستم عامل به شما بدهد؟

سوالات نسبتا چالشی بود و مطمئنا دید خوبی در ادامه‌ی راه خواهد داد ولی اینکه آیا این یعنی عمیق‌تر شدن یا نه مطمئن نیستم. چون انگار وسط یک پروژه فرود اومدیم و قراره یک سری چیز بفهمیم و یک سری کار انجام دهیم و همین! 

> آیا مسئله یا راهنمایی خاصی وجود دارد که بخواهید برای حل مسائل تمرین به دانشجویان ترم‌های آینده بگویید؟

اگه روند کلاس تغییر نکنه نه. بهتره اونا هم زحمتش رو بچشن =)))

> آیا توصیه‌ای برای دستیاران آموزشی دارید که چگونه دانشجویان را در ترم‌های آینده یا در ادامه‌ی ترم بهتر یاری کنند؟

به نظرم برای این فاز طراحی (با توجه به اینکه جمعیت کلاس هم چندان بالا نیست) اگر مثل درس AP یک منتور بود به مراتب کمک بیشتری می‌شد. حداقل برای اینکه دید بهتری دستگیر دانشجو شود. سوال پرسیدن پراکنده تو گروه به ویژه عدم پاسخ‌گیری به موقع چندان کمکی به ما نکرد.
