...
اما ما خروجی ۰ میگرفتیم چون مقدارesp% در ابتدا مضربی از ۱۶ است (0xc0000000). پس کافی است کاری کنیم که باقیمانده `esp%` به ۱۶ برابر ۱۲ شود. پس تغییر زیر را اعمال می‌کنیم.
